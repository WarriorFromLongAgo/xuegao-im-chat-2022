...
public class WsServerHandlerGroup extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    private static final Logger log = LoggerFactory.getLogger(WsServerHandlerGroup.class);
